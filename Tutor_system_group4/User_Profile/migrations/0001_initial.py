# Generated by Django 3.0.4 on 2020-05-27 04:04
            ...
            fields=[
                ...
                ('grade', models.CharField(
                    choices=[('0', '大一'), ('1', '大二'), ('2', '大三'), ('3', '大四'), ('4', '研一'), ('5', '研二'), ('6', '研三'),
                             ('7', '其他')], default='1', max_length=2, verbose_name='教师年级')),
                ('mailbox', models.EmailField(max_length=254, verbose_name='电子邮箱')),
                ('phone', models.CharField(max_length=12, verbose_name='联系电话')),
                ('briefintroduction',
                 models.CharField(blank=True, default='暂无', help_text='个人简介，所在学院/专业/履历等', max_length=100, null=True,
                                  verbose_name='教师信息')),
                ('avatar', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='avatar/%Y/%m/%d/',
                                             verbose_name='头像')),
                ('teacher_user',
            ...
            fields=[
                ...
                ('grade', models.CharField(
                    choices=[('0', '小学一年级至三年级'), ('1', '小学四年级至六年级'), ('2', '初一'), ('3', '初二'), ('4', '初三'), ('5', '高一'),
                             ('6', '高二'), ('7', '高三'), ('8', '其他')], default='5', max_length=2, verbose_name='年级')),
                ('mailbox', models.EmailField(max_length=254, verbose_name='个人邮箱')),
                ('phone', models.CharField(max_length=12, verbose_name='联系电话')),
                ('briefintroduction',
                 models.CharField(blank=True, default='暂无', help_text='个人简介，所在学校/学习情况等', max_length=100, null=True,
                                  verbose_name='教师信息')),
                ('avatar', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='avatar/%Y/%m/%d/',
                                             verbose_name='头像')),
                ('student_user',
