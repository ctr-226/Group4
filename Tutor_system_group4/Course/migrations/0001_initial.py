            ...
            fields=[
                ...
                ('grade_course', models.CharField(
                    choices=[('0', '小学一年级至三年级'), ('1', '小学四年级至六年级'), ('2', '初一'), ('3', '初二'), ('4', '初三'), ('5', '高一'),
                             ('6', '高二'), ('7', '高三'), ('8', '其他')], max_length=2)),
                ('subject', models.CharField(
                    choices=[('zh', '语文'), ('math', '数学'), ('en', '英语'), ('phy', '物理'), ('che', '化学'), ('bio', '生物'),
                             ('pol', '政治'), ('his', '历史'), ('geo', '地理')], max_length=10)),
                ('introduction', models.CharField(default='', max_length=150)),
                ...
                ('student_applied', models.ManyToManyField(related_name='applied_Student', to='User_Profile.Student',
                                                           verbose_name='申请学员')),
